...
This is a challenge submission for UWA Data Analytics Bootcamp, Module 3 Python
...
# Submission
Steps Taken (both questions):

Read in the CSV

Store the header row 

Anasyise the data using Python
